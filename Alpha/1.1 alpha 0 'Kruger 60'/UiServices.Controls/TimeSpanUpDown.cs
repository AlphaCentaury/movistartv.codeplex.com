...
namespace Project.DvbIpTv.UiServices.Controls
{
    public partial class TimeSpanUpDown : UserControl
    {
        ...
        public TimeSpanUpDown()
        {
            ...
            labelTimeSpanD.Text = Properties.Texts.TimeSpanDaysShortLabel;
            labelTimeSpanH.Text = Properties.Texts.TimeSpanHoursShortLabel;
            labelTimeSpanM.Text = Properties.Texts.TimeSpanMinutesShortLabel;
            labelTimeSpanS.Text = Properties.Texts.TimeSpanSecondsShortLabel;
        } // TimeSpanUpDown
