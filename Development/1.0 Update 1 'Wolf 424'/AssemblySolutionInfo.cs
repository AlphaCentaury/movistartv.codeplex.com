...
{
    public const string DefaultAssemblyVersion = "1.0.4010.0";
    public const string AssemblyFileVersion = "1.0.4010.0";
    public const string AssemblyInformationalVersion = "1.0.4010.0";
