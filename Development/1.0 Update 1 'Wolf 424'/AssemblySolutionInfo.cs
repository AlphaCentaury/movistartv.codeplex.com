...
{
    public const string DefaultAssemblyVersion = "1.0.40010.0";
    public const string AssemblyFileVersion = "1.0.40010.0";
    public const string AssemblyInformationalVersion = "1.0.40010.0";
    public const string AssemblyProduct = "movistar+ DVB-IPTV software decoder" + " (v" + ProductVersion + ")";
    public const string ProductVersion = "1.0 Update 1 \"Wolf 424\"";
