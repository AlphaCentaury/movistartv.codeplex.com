...
namespace Project.DvbIpTv.UiServices.Controls
{
    public partial class RecordingTime : UserControl
    {
        ...
        private void InitComboQuickSettings(ComboBox combo)
        {
            ...
            lines = Properties.Texts.RecordTimeQuickSettings.Split(linesSeparators, StringSplitOptions.RemoveEmptyEntries);
        ...
        private void ValidateEndDateTime(DateTimePicker sender, CancelEventArgs e)
        {
            ...
            {
                e.Cancel = true;
                MessageBox.Show(this, Properties.Texts.RecordingTimeInvalidDateTime, Properties.Texts.RecordingTimeValidationCaption, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                this.Parent.Focus();
                this.Focus();
                return;
            } // if
            ...
            {
                e.Cancel = true;
                MessageBox.Show(this, string.Format(Properties.Texts.RecordingTimeDateTimeSpanMaxValue, timeSpanLength.MaxDays),
                    Properties.Texts.RecordingTimeValidationCaption, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                this.Parent.Focus();
                this.Focus();
            } // if
        } // ValidateEndDateTime
