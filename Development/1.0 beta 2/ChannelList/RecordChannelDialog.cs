...
{
    public partial class RecordChannelDialog : Form
    {
        ...
        private void DialogRecordChannel_Shown(object sender, EventArgs e)
        {
            if (CurrentSelectedLocationIndex >= 0)
            {
                ...
                System.Diagnostics.Debug.Assert(listViewLocations.IsHandleCreated);
        ...
        private void textTaskName_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (e.Cancel)
            {
                ControlValidationFailed(Properties.Texts.DialogRecordChannelEmptyTaskName, sender as Control);
            } // if
        ...
        private void UpdateTaskName()
        {
            ...
            var taskName = string.Format(Properties.Texts.RecordTaskNameSuggestedNameFormat, Task.Channel.Name, CurrentStartDateTime, CurrentStartDateTime);
        ...
        private void GetSaveData()
        {
            ...
            if (locationName == Properties.Texts.DialogRecordSaveDefaultLocation) locationName = null;
        ...
        private void textFilename_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (e.Cancel)
            {
                ControlValidationFailed(Properties.Texts.DialogRecordChannelEmptyFileName, sender as Control);
            } // if
        ...
        private void comboFileExtension_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (e.Cancel)
            {
                ControlValidationFailed(Properties.Texts.DialogRecordChannelEmptyFileExtension, sender as Control);
            } // if
        ...
        private void listViewLocations_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (e.Cancel)
            {
                ControlValidationFailed(Properties.Texts.DialogRecordChannelNoSaveLocation, sender as Control);
            } // if
        ...
        private ListViewItem SetListLocations(IList<RecordSaveLocation> locations)
        {
            ...
            for (int index = 0; index < locations.Count; index++)
            {
                ...
                if (string.IsNullOrEmpty(name)) name = Properties.Texts.DialogRecordSaveDefaultLocation;
        ...
        private void SelectSaveLocation(string locationName, string path, ListViewItem defaultItem)
        {
            ...
            if (item == null)
            {
                ...
                {
                    locationName = (locationName != null) ? Properties.Texts.DialogRecordSaveMissingLocation : Properties.Texts.DialogRecordSaveCustomLocation;
        ...
        private void SelectAppendSaveLocation(string path)
        {
            ...
            if (item == null)
            {
                item = listViewLocations.Items.Add(Properties.Texts.DialogRecordSaveCustomLocation);
                item.ImageKey = ListLocationsDefaultImageKey;
        ...
        private void InitAdvancedData()
        {
            ...
            comboSchedulerFolder.Items.Add(new RecordTaskSchedulerFolder(Properties.Texts.TaskSchedulerRootFolder, ""));
