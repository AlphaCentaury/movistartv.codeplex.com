...
{
    public const string DefaultAssemblyVersion = "1.0.1000.100";
    public const string AssemblyFileVersion = "1.0.1000.100";
    public const string AssemblyInformationalVersion = "1.0.1000.100";
    public const string AssemblyProduct = "MovistarTV DVB-IPTV software decoder" + " (" + ProductVersion + ")";
    public const string ProductVersion = "1.0 beta 1 \"Wolf 424\"";
