...
namespace Project.DvbIpTv.UiServices.Controls
{
    internal partial class RecordingWeeklyScheduleFragment : UserControl, IRecordingScheduleFragment
    {
        ...
        private void checkedListDays_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                e.Cancel = true;
                MessageBox.Show(this, Properties.Texts.WeeklyScheduleNoDays, Properties.Texts.RecordingScheduleValidationCaption, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                this.Focus();
