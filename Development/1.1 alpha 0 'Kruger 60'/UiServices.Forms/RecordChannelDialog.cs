...
namespace Project.DvbIpTv.UiServices.Forms
{
    public partial class RecordChannelDialog : CommonBaseForm
    {
        ...
        private void textTaskName_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (e.Cancel)
            {
                ControlValidationFailed(Record.EmptyTaskName, sender as Control);
            } // if
        ...
        private void UpdateTaskName()
        {
            ...
            var taskName = string.Format(Record.RecordTaskNameSuggestedNameFormat, Task.Channel.Name, CurrentStartDateTime, CurrentStartDateTime);
        ...
        private void GetSaveData()
        {
            ...
            if (locationName == Record.SaveDefaultLocation) locationName = null;
        ...
        private void textFilename_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (e.Cancel)
            {
                ControlValidationFailed(Record.EmptyFileName, sender as Control);
            } // if
        ...
        private void comboFileExtension_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (e.Cancel)
            {
                ControlValidationFailed(Record.EmptyFileExtension, sender as Control);
            } // if
        ...
        private void listViewLocations_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (e.Cancel)
            {
                ControlValidationFailed(Record.NoSaveLocation, sender as Control);
            } // if
        ...
        private ListViewItem SetListLocations(IList<RecordSaveLocation> locations)
        {
            ...
            for (int index = 0; index < locations.Count; index++)
            {
                ...
                if (string.IsNullOrEmpty(name)) name = Record.SaveDefaultLocation;
        ...
        private void SelectSaveLocation(string locationName, string path, ListViewItem defaultItem)
        {
            ...
            if (item == null)
            {
                ...
                {
                    locationName = (locationName != null) ? Record.SaveMissingLocation : Record.SaveCustomLocation;
        ...
        private void SelectAppendSaveLocation(string path)
        {
            ...
            if (item == null)
            {
                item = listViewLocations.Items.Add(Record.SaveCustomLocation);
                item.ImageKey = ListLocationsDefaultImageKey;
        ...
        private void InitAdvancedData()
        {
            ...
            comboSchedulerFolder.Items.Add(new RecordTaskSchedulerFolder(Record.TaskSchedulerRootFolder, ""));
